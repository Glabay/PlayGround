...
public class Level implements Serializable {
	...
	public List<com.IB.SL.entity.spawner.Spawner> Spawner = new ArrayList<com.IB.SL.entity.spawner.Spawner>();
	...
	int SandBrickWallHex = 0xffBFBC85;
...
//	public static String currentLevel = spawn.toString();
	...
	public void updateTest() {
	 ...
	 public String returnTile() {
		...
		tileString = tileString.replace("SL.level.tile.", "");
